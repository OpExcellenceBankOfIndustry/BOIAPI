...
namespace BOI.BOIApplications.Infrastructure.HTMLBuilder
{
    ...
    {
        public static string GenerateHtmlMail(string? businessName, string username, string callbackUrl)
        {
                ...
                <table style=""background-color: #f2f3f8; max-width:670px;  margin:0 auto;"" width=""100%"" border=""0""
                    ...
                    <tr>
                        <td style=""text-align:center;"">
                          <a href=""{callbackUrl}"" title=""logo"" target=""_blank"">
                                    ...
                                    <td style=""padding:0 35px;"">
                                      ...
                                      <br>
                                        ...
                                        <p style=""color:#455056; font-size:15px;line-height:24px; margin:0;"">
                                           Welcome to the team! We are thrilled to have you on the TME platform. You’re going to be a valuable asset to our company, and we can’t wait to see all that you will accomplish.
                                        </p>
                                      <br><br>
                    ...
                    <tr>
                        <td style=""text-align:center;"">
                            <p style=""font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;"">&copy; <strong>{callbackUrl}</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style=""height:80px;"">&nbsp;</td>
