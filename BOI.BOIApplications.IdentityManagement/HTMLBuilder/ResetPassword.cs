                            ...
                            <table width=""95%"" border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0""
                                ...
                                <tr>
                                    <td style=""padding:0 35px;"">
                                      <p style=""color:#455056; font-size:20px;line-height:44px; margin:0; text-align: left;"">Hi {businessName},</p> 
                                      <br>
                                      <br>
                                        <h1 style=""color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;"">Welcome to TME</h1>
                                        <span
                                        ...
                                        <p style=""color:#455056; font-size:15px;line-height:24px; margin:0;"">
                                           Password has been Reset Successfully.    </p>
                                      <br><br>
